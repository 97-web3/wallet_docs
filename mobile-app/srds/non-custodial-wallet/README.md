...
| 序号 | 文档 | 页面名称 | 描述 |
|------|------|----------|------|
| 36 | [36-swap-select-token-requirements.md](./36-swap-select-token-requirements.md) | 闪兑-选择代币 | 选择要兑换的源代币和目标代币 |
| 37 | [37-swap-details-requirements.md](./37-swap-details-requirements.md) | 闪兑详情 | 输入金额、查看汇率和费用 |
| 38 | [38-swap-confirm-requirements.md](./38-swap-confirm-requirements.md) | 闪兑确认 | 确认交易并使用私钥签名 |
| 39 | [39-swap-result-requirements.md](./39-swap-result-requirements.md) | 闪兑结果 | 显示交易结果和状态 |
| 40 | [40-swap-history-requirements.md](./40-swap-history-requirements.md) | 闪兑记录 | 查看历史闪兑交易记录 |
...
### 闪兑流程
```
主页 → 选择代币对 → 输入金额（查看汇率/滑点） → 私钥签名 → 确认兑换 → 等待结果 → 完成/失败
```
...
- [Web2钱包SRDs](../custodial-wallet/) - Web2钱包需求文档（46个页面）
...
| 2025-12-09 | 1.3 | 新增闪兑模块(36-40)，使用本地私钥签名，共40个页面 |
