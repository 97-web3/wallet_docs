...
本目录为加密货币钱包系统的 软件需求规格说明书 (SRD)，按模块组织，记录所有已实现的功能。
...
| 序号 | 文档名称                                        | 描述                                          | 功能数量 |
| ---- | ----------------------------------------------- | --------------------------------------------- | -------- |
| 01   | [API 网关](./01-api-gateway/)                   | HTTP 网关、路由、认证、速率限制               | 20+      |
| 02   | [业务服务](./02-business-service/)              | 用户管理、认证、资产、充提、闪兑、通知        | 48 RPC   |
...
| 06   | [通用库与基础设施](./06-common-infrastructure/) | 共享库、数据库、部署配置                      | -        |
| 07   | [后台管理服务](./07-admin-service/)             | Dashboard、用户管理、薪资发放、提现审批、RBAC | 30+      |
...
| [09-偏好设置](./02-business-service/09-偏好设置.md)             | 语言、时区、货币、多语言资源     |
| [10-钱包地址管理](./02-business-service/10-钱包地址管理.md)     | 地址簿管理                       |
| [11-登录记录](./02-business-service/11-登录记录.md)             | 登录历史查询                     |
| [12-闪兑功能](./02-business-service/12-闪兑功能.md)             | 代币闪兑、报价、滑点配置         |
...
| [03-Gas 管理](./03-chainrpc-service/03-Gas管理.md)              | Gas 估算、价格获取           |
...
| 链                  | 代号  | 原生币 | 代币标准 | 状态                     |
| ------------------- | ----- | ------ | -------- | ------------------------ |
| TRON                | TRX   | TRX    | TRC20    | 已实现                   |
| Binance Smart Chain | BSC   | BNB    | BEP20    | 已实现                   |
| Ethereum            | ETH   | ETH    | ERC20    | 已实现                   |
| Polygon             | MATIC | MATIC  | ERC20    | 可用但禁用 (V1 暂不开放) |

> **注**: Polygon 链已完成技术集成，但 V1 版本暂不对外开放，计划在后续版本启用。
