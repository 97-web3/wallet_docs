...
| 审批转账批次 | POST | /api/v1/admin/transfer/batches/{batch_id}/approve |
| 执行转账批次 | POST | /api/v1/admin/transfer/batches/{batch_id}/execute |
| 重试失败转账 | POST | /api/v1/admin/transfer/batches/{batch_id}/retry |
...
| 审批转账批次 | /api/v1/admin/transfer/batches/{batch_id}/approve |
| 执行转账批次 | /api/v1/admin/transfer/batches/{batch_id}/execute |
